...
import com.technosoft.webservices.validator.PasswordConstraintValidator;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleUserNotFoundException(BookingNotFoundException ex) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), ex.getMessage());
	...
	public ResponseEntity<Object> handleViolation(ValidationException ex) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(), "Please include password field");
		return new ResponseEntity<Object>(exceptionResponse, HttpStatus.BAD_REQUEST);
	}
